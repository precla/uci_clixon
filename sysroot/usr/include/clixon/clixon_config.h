...
/* Pass-through $bindir */
#define CLIXON_CONFIG_BINDIR "/usr/bin"

/* Pass-through $localstatedir */
#define CLIXON_CONFIG_LOCALSTATEDIR "/var"

/* Pass-through $sbindir */
#define CLIXON_CONFIG_SBINDIR "/usr/sbin"

/* Pass-through $sysconfdir */
#define CLIXON_CONFIG_SYSCONFDIR "/etc"

/* Location for apps to find default config file */
#define CLIXON_DEFAULT_CONFIG "/etc/clixon/clixon.xml"
